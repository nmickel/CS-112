...
# 
#     python3 testerP1.py yourfilehere.py
#
# (if you're on windows, instead use "python testerP1.py yourfilehere.py").
# 
# This file needs the corresponding testsP1.txt file to be in the
# same directory.
# 
